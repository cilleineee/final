...
st.write("## 🐱Cat Breed Classification Model🐾")
st.write("Upload an image of a cat, and we'll predict its breed based on our trained model!")
st.write("Prediction is limited to the ff. breeds🐱🐾: AMERICAN SHORTHAIR, BENGAL, MAINE COON, RAGDOLL, SCOTTISHFOLD, AND SPHINX")
...
if my_upload is not None:
    ...
    st.write("by Edcille Deine Telequido.")
